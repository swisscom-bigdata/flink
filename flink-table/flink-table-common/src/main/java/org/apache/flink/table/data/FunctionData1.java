 ...
 * structures}.
 *
 * <p>This is the internal-data counterpart of {@link org.apache.flink.util.function.Function1},
 * which a function receives when it works on external classes. Which of the two a lambda argument
 * is passed as is not a property of the lambda but of the function that receives it: it is the
 * conversion class of the argument's {@link FunctionType} and is therefore declared by the
 * function's type inference, in the same way that an {@code ARRAY} argument is received either as
 * {@code ArrayData} or as an array of external elements.
 *
...
@PublicEvolving
@FunctionalInterface
public interface FunctionData1 {
