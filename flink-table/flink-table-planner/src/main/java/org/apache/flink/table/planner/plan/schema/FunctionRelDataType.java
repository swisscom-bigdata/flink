...
public final class FunctionRelDataType extends AbstractSqlType {
    ...
    /**
     * Returns this type unchanged: the nullability of a {@code FUNCTION} type is not meaningful. A
     * lambda argument is a compile-time helper that is never materialized as a runtime value (see
     * {@link FunctionType} and {@code InternalSerializers}, which rejects it), so it can never be
     * {@code NULL}.
     */
